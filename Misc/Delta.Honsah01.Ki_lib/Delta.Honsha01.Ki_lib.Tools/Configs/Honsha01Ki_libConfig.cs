...
namespace Delta.Honsha01.Ki_lib.Tools.Configs
{
    public class Honsha01Ki_libConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Ki_lib;

        public static Honsha01Ki_libConfig Of() => new Honsha01Ki_libConfig();

        Honsha01Ki_libConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = Ki_libLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            //rtn.Add(Honsha01LibraryList.Ki_lib.ObjectIDOf("JKIE05D0"));
            //rtn.Add(Honsha01LibraryList.Ki_lib.ObjectIDOf("JKIF05M0"));
            //rtn.Add(Honsha01LibraryList.Ki_lib.ObjectIDOf("JKIH05D0"));
            rtn.Add(Honsha01LibraryList.Ki_lib.ObjectIDOf("JKIH05W0"));
