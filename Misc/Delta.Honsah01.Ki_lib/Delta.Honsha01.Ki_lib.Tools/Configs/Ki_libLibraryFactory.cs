...
{
    class Ki_libLibraryFactory : LibraryFactory
    {

        Ki_libLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static Ki_libLibraryFactory Of(Library aMainLibrary)
        {
        ...
        **/
            ...
            return new Ki_libLibraryFactory(ReferLibraries);
        }
