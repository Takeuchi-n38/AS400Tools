...
{
    class AdsslibLibraryFactory : LibraryFactory
    {

        AdsslibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static AdsslibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){

                Honsha01LibraryList.Adsslib,
            ...
            return new AdsslibLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            if (libraryName == "&CUR") return Honsha01LibraryList.Adsslib;
