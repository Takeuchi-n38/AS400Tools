...
namespace Delta.Honsha01.Adsslib.Tools.Configs
{
    public class Honsha01AdsslibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Adsslib;

        public static Honsha01AdsslibConfig Of() => new Honsha01AdsslibConfig();

        Honsha01AdsslibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = AdsslibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Adsslib.ObjectIDOf("JIJZ70D0"));
            rtn.Add(Honsha01LibraryList.Adsslib.ObjectIDOf("JIJZ20W0"));
            rtn.Add(Honsha01LibraryList.Adsslib.ObjectIDOf("JIJZ25W0"));
            rtn.Add(Honsha01LibraryList.Adsslib.ObjectIDOf("JIJZ30W0"));
            rtn.Add(Honsha01LibraryList.Adsslib.ObjectIDOf("JIJZ35W0"));
            rtn.Add(Honsha01LibraryList.Adsslib.ObjectIDOf("JIJZ40W0"));
            rtn.Add(Honsha01LibraryList.Adsslib.ObjectIDOf("JIJZ45W0"));
            rtn.Add(Honsha01LibraryList.Adsslib.ObjectIDOf("JIJZ50W0"));
            rtn.Add(Honsha01LibraryList.Adsslib.ObjectIDOf("JIJZ55W0"));
            rtn.Add(Honsha01LibraryList.Adsslib.ObjectIDOf("JIJZ56W0"));
            rtn.Add(Honsha01LibraryList.Adsslib.ObjectIDOf("JIJZ60W0"));
