...
{
    class Aki_libLibraryFactory : LibraryFactory
    {

        Aki_libLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static Aki_libLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){

                Honsha01LibraryList.Aki_lib,
            ...
            return new Aki_libLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            if (libraryName == "&AKI") return Honsha01LibraryList.Aki_lib;
