...
namespace Delta.Honsha01.Aki_lib.Tools.Configs
{
    public class Honsha01Aki_libConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Aki_lib;

        public static Honsha01Aki_libConfig Of() => new Honsha01Aki_libConfig();

        Honsha01Aki_libConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = Aki_libLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Aki_lib.ObjectIDOf("JIJU70D0"));
            rtn.Add(Honsha01LibraryList.Aki_lib.ObjectIDOf("JIJU20W0"));
            rtn.Add(Honsha01LibraryList.Aki_lib.ObjectIDOf("JIJU25W0"));
            rtn.Add(Honsha01LibraryList.Aki_lib.ObjectIDOf("JIJU30W0"));
            rtn.Add(Honsha01LibraryList.Aki_lib.ObjectIDOf("JIJU35W0"));
            rtn.Add(Honsha01LibraryList.Aki_lib.ObjectIDOf("JIJU40W0"));
            rtn.Add(Honsha01LibraryList.Aki_lib.ObjectIDOf("JIJU45W0"));
            rtn.Add(Honsha01LibraryList.Aki_lib.ObjectIDOf("JIJU50W0"));
            rtn.Add(Honsha01LibraryList.Aki_lib.ObjectIDOf("JIJU55W0"));
            rtn.Add(Honsha01LibraryList.Aki_lib.ObjectIDOf("JIJU56W0"));
            rtn.Add(Honsha01LibraryList.Aki_lib.ObjectIDOf("JIJU60W0"));
