...
{
    class AkuslibLibraryFactory : LibraryFactory
    {

        AkuslibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static AkuslibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){

                Honsha01LibraryList.Akuslib,
                ...
                Honsha01LibraryList.Packlib,
                Honsha01LibraryList.Hostlib,

        };
            return new AkuslibLibraryFactory(ReferLibraries);
        }
