...
namespace Delta.Honsha01.Akuslib.Tools.Configs
{
    public class Honsha01AkiuslibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Akuslib;

        public static Honsha01AkiuslibConfig Of() => new Honsha01AkiuslibConfig();

        Honsha01AkiuslibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = AkuslibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Akuslib.ObjectIDOf("JIKC20W0"));
            rtn.Add(Honsha01LibraryList.Akuslib.ObjectIDOf("JIKC25W0"));
            rtn.Add(Honsha01LibraryList.Akuslib.ObjectIDOf("JIKC30W0"));
            rtn.Add(Honsha01LibraryList.Akuslib.ObjectIDOf("JIKC35W0"));
            rtn.Add(Honsha01LibraryList.Akuslib.ObjectIDOf("JIKC40W0"));
            rtn.Add(Honsha01LibraryList.Akuslib.ObjectIDOf("JIKC45W0"));
            rtn.Add(Honsha01LibraryList.Akuslib.ObjectIDOf("JIKC50W0"));
            rtn.Add(Honsha01LibraryList.Akuslib.ObjectIDOf("JIKC55W0"));
            rtn.Add(Honsha01LibraryList.Akuslib.ObjectIDOf("JIKC56W0"));
            rtn.Add(Honsha01LibraryList.Akuslib.ObjectIDOf("JIKC60W0"));
