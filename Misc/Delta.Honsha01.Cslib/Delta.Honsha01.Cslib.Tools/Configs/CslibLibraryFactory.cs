...
{
    class CslibLibraryFactory : LibraryFactory
    {

        CslibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static CslibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){
                 Honsha01LibraryList.Cslib,
                 Honsha01LibraryList.Oplib,
                 Honsha01LibraryList.Wklib,
                 Honsha01LibraryList.Tr2lib,
        ...
        Honsha01LibraryList.Wrkcat1,
            ...
            return new CslibLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            if (libraryName == "&LIB") return Honsha01LibraryList.Cslib;
            ...
            if (libraryName == "&CS") return Honsha01LibraryList.Cslib;
            if (libraryName == "&CS_") return Honsha01LibraryList.Cslib;
