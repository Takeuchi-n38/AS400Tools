...
namespace Delta.Honsha01.Cslib.Tools.Configs
{
    public class Honsha01CslibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Cslib;

        public static Honsha01CslibConfig Of() => new Honsha01CslibConfig();
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = CslibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Cslib.ObjectIDOf("JCSA00D0"));
            rtn.Add(Honsha01LibraryList.Cslib.ObjectIDOf("JCSB00D0"));
            rtn.Add(Honsha01LibraryList.Cslib.ObjectIDOf("JCSZ01D0"));
