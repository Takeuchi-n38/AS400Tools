...
{
    class DaclibLibraryFactory : LibraryFactory
    {

        DaclibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static DaclibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){

                Honsha01LibraryList.Daclib,
            ...
            return new DaclibLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            if (libraryName == "&DAC") return Honsha01LibraryList.Daclib;
