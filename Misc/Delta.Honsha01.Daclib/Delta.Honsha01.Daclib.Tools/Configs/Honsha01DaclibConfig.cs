...
namespace Delta.Honsha01.Daclib.Tools.Configs
{
    public class Honsha01DaclibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Daclib;

        public static Honsha01DaclibConfig Of() => new Honsha01DaclibConfig();

        Honsha01DaclibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = DaclibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Daclib.ObjectIDOf("JIJW70D0"));
