...
{
    class Dpd2libLibraryFactory : LibraryFactory
    {

        Dpd2libLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static Dpd2libLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){

                Honsha01LibraryList.Dpd2lib,
            ...
            return new Dpd2libLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            if (libraryName == "&CUR") return Honsha01LibraryList.Dpd2lib;
