...
namespace Delta.Honsha01.Dpd2lib.Tools.Configs
{
    public class Honsha01Dpd2libConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Dpd2lib;

        public static Honsha01Dpd2libConfig Of() => new Honsha01Dpd2libConfig();

        Honsha01Dpd2libConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = Dpd2libLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Dpd2lib.ObjectIDOf("JIKB70D0"));
            rtn.Add(Honsha01LibraryList.Dpd2lib.ObjectIDOf("JIKB20W0"));
            rtn.Add(Honsha01LibraryList.Dpd2lib.ObjectIDOf("JIKB25W0"));
            rtn.Add(Honsha01LibraryList.Dpd2lib.ObjectIDOf("JIKB30W0"));
            rtn.Add(Honsha01LibraryList.Dpd2lib.ObjectIDOf("JIKB35W0"));
            rtn.Add(Honsha01LibraryList.Dpd2lib.ObjectIDOf("JIKB40W0"));
            rtn.Add(Honsha01LibraryList.Dpd2lib.ObjectIDOf("JIKB45W0"));
            rtn.Add(Honsha01LibraryList.Dpd2lib.ObjectIDOf("JIKB50W0"));
            rtn.Add(Honsha01LibraryList.Dpd2lib.ObjectIDOf("JIKB55W0"));
            rtn.Add(Honsha01LibraryList.Dpd2lib.ObjectIDOf("JIKB56W0"));
            rtn.Add(Honsha01LibraryList.Dpd2lib.ObjectIDOf("JIKB60W0"));
