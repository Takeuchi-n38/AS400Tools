...
{
    class DpddlibLibraryFactory : LibraryFactory
    {

        DpddlibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static DpddlibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){

                Honsha01LibraryList.Dpddlib,
            ...
            return new DpddlibLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            if (libraryName == "&DPD") return Honsha01LibraryList.Dpddlib;
