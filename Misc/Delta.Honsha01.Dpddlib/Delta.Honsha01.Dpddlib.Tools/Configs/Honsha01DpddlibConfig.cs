...
namespace Delta.Honsha01.Dpddlib.Tools.Configs
{
    public class Honsha01DpddlibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Dpddlib;

        public static Honsha01DpddlibConfig Of() => new Honsha01DpddlibConfig();

        Honsha01DpddlibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = DpddlibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Dpddlib.ObjectIDOf("JIJY20W0"));
            rtn.Add(Honsha01LibraryList.Dpddlib.ObjectIDOf("JIJY25W0"));
            rtn.Add(Honsha01LibraryList.Dpddlib.ObjectIDOf("JIJY30W0"));
            rtn.Add(Honsha01LibraryList.Dpddlib.ObjectIDOf("JIJY35W0"));
            rtn.Add(Honsha01LibraryList.Dpddlib.ObjectIDOf("JIJY40W0"));
            rtn.Add(Honsha01LibraryList.Dpddlib.ObjectIDOf("JIJY45W0"));
            rtn.Add(Honsha01LibraryList.Dpddlib.ObjectIDOf("JIJY50W0"));
            rtn.Add(Honsha01LibraryList.Dpddlib.ObjectIDOf("JIJY55W0"));
            rtn.Add(Honsha01LibraryList.Dpddlib.ObjectIDOf("JIJY56W0"));
            rtn.Add(Honsha01LibraryList.Dpddlib.ObjectIDOf("JIJY60W0"));
