...
{
    class EialibLibraryFactory : LibraryFactory
    {

        EialibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static EialibLibraryFactory Of(Library aMainLibrary)
        {
        ...
        Honsha01LibraryList.Wrkcat1,
            ...
            return new EialibLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            //if (libraryName == "&LIB") return Honsha01LibraryList.Wrkcat3;
