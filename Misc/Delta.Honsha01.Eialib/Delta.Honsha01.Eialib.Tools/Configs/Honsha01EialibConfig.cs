...
namespace Delta.Honsha01.Eialib.Tools.Configs
{
    public class Honsha01EialibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Eialib;

        public static Honsha01EialibConfig Of() => new Honsha01EialibConfig();

        Honsha01EialibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = EialibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            //rtn.Add(Honsha01LibraryList.Eialib.ObjectIDOf("JEIA50M2"));
            //rtn.Add(Honsha01LibraryList.Eialib.ObjectIDOf("JEIA50M3"));
            //rtn.Add(Honsha01LibraryList.Eialib.ObjectIDOf("JEIA60D0"));
            rtn.Add(Honsha01LibraryList.Eialib.ObjectIDOf("JEIA00M0"));
            rtn.Add(Honsha01LibraryList.Eialib.ObjectIDOf("JEIA10M0"));
            rtn.Add(Honsha01LibraryList.Eialib.ObjectIDOf("JEIA60W0"));
