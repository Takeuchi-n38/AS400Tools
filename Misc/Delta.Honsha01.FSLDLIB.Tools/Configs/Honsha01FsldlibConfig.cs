...
{
    public class Honsha01FsldlibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Fsldlib;

        public static Honsha01FsldlibConfig Of() => new Honsha01FsldlibConfig();

        Honsha01FsldlibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = FsldlibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(((IToolConfig)this).MainLibrary.ObjectIDOf("CFSLD"));
            rtn.Add(((IToolConfig)this).MainLibrary.ObjectIDOf("CJIEA01"));
            rtn.Add(((IToolConfig)this).MainLibrary.ObjectIDOf("CJIEA02"));
            rtn.Add(((IToolConfig)this).MainLibrary.ObjectIDOf("CJIERERUN"));
