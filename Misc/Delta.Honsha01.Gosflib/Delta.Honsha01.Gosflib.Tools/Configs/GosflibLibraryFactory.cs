...
{
    class GosflibLibraryFactory : LibraryFactory
    {

        GosflibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static GosflibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){

                Honsha01LibraryList.Gosflib,
            ...
            return new GosflibLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            if (libraryName == "&GOS") return Honsha01LibraryList.Gosflib;
