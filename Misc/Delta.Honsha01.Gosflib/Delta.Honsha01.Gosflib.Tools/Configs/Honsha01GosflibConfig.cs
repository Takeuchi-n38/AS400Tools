...
namespace Delta.Honsha01.Gosflib.Tools.Configs
{
    public class Honsha01GosflibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Gosflib;

        public static Honsha01GosflibConfig Of() => new Honsha01GosflibConfig();

        Honsha01GosflibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = GosflibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Gosflib.ObjectIDOf("JIJV70D0"));
