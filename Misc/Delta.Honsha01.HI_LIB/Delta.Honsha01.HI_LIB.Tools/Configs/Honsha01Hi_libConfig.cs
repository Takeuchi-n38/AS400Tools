...
{
    public class Honsha01Hi_libConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Hi_lib;

        public static Honsha01Hi_libConfig Of() => new Honsha01Hi_libConfig();

        Honsha01Hi_libConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = Hi_libLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("CHIA001"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("CHIA002"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("CHIM010"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("CHIR010"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIA70D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIA71D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIA85D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIA91D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIAA5D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIAB0D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIAB5D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIAC0D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIAC5D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIAD0D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIAD5D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIAF0D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIAF5D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIAG0D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIAG5D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIC01D0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIC70M0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIC80M0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIC90M0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIC91M0"));
            //rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIC92M0"));
            rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIAF6W0"));
            rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIAG6W0"));
            rtn.Add(Honsha01LibraryList.Hi_lib.ObjectIDOf("JHIC01W0"));
