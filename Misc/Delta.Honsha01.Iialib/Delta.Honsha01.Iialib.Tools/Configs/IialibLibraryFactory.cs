...
{
    class IialibLibraryFactory : LibraryFactory
    {

        IialibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static IialibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){
                ...
                Honsha01LibraryList.Ibhlib,
                Honsha01LibraryList.Hostlib,
                Honsha01LibraryList.Tachilib,
                Honsha01LibraryList.Sigelib,
                Honsha01LibraryList.Tstech2lib,

        };
            return new IialibLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            //if (libraryName == "&LIB") return Honsha01LibraryList.Tstcat1; //JIIA05W0
            //if (libraryName == "&LIB") return Honsha01LibraryList.Wrkcat7; //JIIA13W0
            if (libraryName == "&LIB") return Honsha01LibraryList.Iialib; //JIIAP2W0,JIIBXXW0
            //if (libraryName == "&JI_") return Honsha01LibraryList.Ji_lib;
