...
namespace Delta.Honsha01.Iiclib.Tools.Configs
{
    public class Honsha01IiclibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Iiclib;

        public static Honsha01IiclibConfig Of() => new Honsha01IiclibConfig();

        Honsha01IiclibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = IiclibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC10W0"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC11D0"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC12D0"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC12D1"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC13D0"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC13D1"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC14D0"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC15D0"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC15D1"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC20W0"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC21D0"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC24D0"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC30W0"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC31D0"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC40W0"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC41W0"));
            //rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIIC44D0"));
            rtn.Add(Honsha01LibraryList.Iiclib.ObjectIDOf("JIICXXD0"));
