...
{
    class IiclibLibraryFactory : LibraryFactory
    {

        IiclibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static IiclibLibraryFactory Of(Library aMainLibrary)
        {
        ...
        Honsha01LibraryList.Wrkcat1,
            ...
            return new IiclibLibraryFactory(ReferLibraries);
        }
