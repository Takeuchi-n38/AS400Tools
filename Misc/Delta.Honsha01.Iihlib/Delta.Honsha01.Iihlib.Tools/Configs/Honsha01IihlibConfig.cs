...
namespace Delta.Honsha01.Iihlib.Tools.Configs
{
    public class Honsha01IihlibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = IihlibLibraryFactory.Iihlib;

        public static Honsha01IihlibConfig Of() => new Honsha01IihlibConfig();

        Honsha01IihlibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = IihlibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(IihlibLibraryFactory.Iihlib.ObjectIDOf("CIIH011"));
