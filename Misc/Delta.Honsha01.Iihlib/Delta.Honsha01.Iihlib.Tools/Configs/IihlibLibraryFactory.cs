...
{
    class IihlibLibraryFactory : LibraryFactory
    {

        IihlibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }
        public static Library  Iihlib = Library.Of(Partition.Honsha01, "IIHLIB");

        public static IihlibLibraryFactory Of(Library aMainLibrary)
        {
            ...
            return new IihlibLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            if (libraryName == "&KWXT") return Honsha01LibraryList.Kwxtlib;
