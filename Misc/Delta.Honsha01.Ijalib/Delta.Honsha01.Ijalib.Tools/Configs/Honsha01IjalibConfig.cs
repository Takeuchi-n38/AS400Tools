...
{
    public class Honsha01IjalibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Ijalib;

        public static Honsha01IjalibConfig Of() => new Honsha01IjalibConfig();

        Honsha01IjalibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = IjalibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Ijalib.ObjectIDOf("JEIF05D0"));
            rtn.Add(Honsha01LibraryList.Ijalib.ObjectIDOf("JEIF15D0"));
            rtn.Add(Honsha01LibraryList.Ijalib.ObjectIDOf("JIJA05D0"));
            rtn.Add(Honsha01LibraryList.Ijalib.ObjectIDOf("JIJA10D0"));
