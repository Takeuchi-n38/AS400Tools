...
{
    class IjdlibLibraryFactory : LibraryFactory
    {

        IjdlibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static IjdlibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){
                 Honsha01LibraryList.Ijdlib,
                 Honsha01LibraryList.Prodlib,
                 Honsha01LibraryList.Master2,
                 Honsha01LibraryList.Uprslib,
        ...
        Honsha01LibraryList.Wrkcat1,
            ...
            return new IjdlibLibraryFactory(ReferLibraries);
        }
