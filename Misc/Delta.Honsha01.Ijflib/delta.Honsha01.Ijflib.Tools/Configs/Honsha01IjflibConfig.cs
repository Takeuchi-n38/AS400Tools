...
namespace Delta.Honsha01.Ijflib.Tools.Configs
{
    public class Honsha01IjflibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Ijflib;

        public static Honsha01IjflibConfig Of() => new Honsha01IjflibConfig();

        Honsha01IjflibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = IjflibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            //rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJH70D0"));
            //rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJK70D0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJH20W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJH25W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJH30W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJH35W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJH40W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJH45W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJH48W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJH50W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJH55W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJH56W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJH60W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJK20W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJK25W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJK30W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJK35W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJK40W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJK45W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJK48W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJK50W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJK55W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJK56W0"));
            rtn.Add(Honsha01LibraryList.Ijflib.ObjectIDOf("JIJK60W0"));
