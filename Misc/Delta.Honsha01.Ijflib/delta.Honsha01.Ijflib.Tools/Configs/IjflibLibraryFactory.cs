...
{
    class IjflibLibraryFactory : LibraryFactory
    {

        IjflibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static IjflibLibraryFactory Of(Library aMainLibrary)
        {
        ...
        Honsha01LibraryList.Wrkcat1,
            ...
            return new IjflibLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            //if (libraryName == "&FLL") return Honsha01LibraryList.Wrkcat3;
