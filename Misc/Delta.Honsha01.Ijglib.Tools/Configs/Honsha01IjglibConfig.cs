...
{
    public class Honsha01IjglibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Ijglib;

        public static Honsha01IjglibConfig Of() => new Honsha01IjglibConfig();

        Honsha01IjglibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = IjglibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Ijglib.ObjectIDOf("JIJG05D0"));
