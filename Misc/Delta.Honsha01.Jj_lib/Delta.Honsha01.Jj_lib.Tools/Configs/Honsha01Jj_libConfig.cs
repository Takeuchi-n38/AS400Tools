...
namespace Delta.Honsha01.Jj_lib.Tools.Configs
{
    public class Honsha01Jj_libConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Jj_lib;
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = Jj_libLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Jj_lib.ObjectIDOf("JJJD13D0"));
            rtn.Add(Honsha01LibraryList.Jj_lib.ObjectIDOf("JJJD19D2"));
            rtn.Add(Honsha01LibraryList.Jj_lib.ObjectIDOf("JJJD19D0"));
            rtn.Add(Honsha01LibraryList.Jj_lib.ObjectIDOf("JJJD02D1"));
            rtn.Add(Honsha01LibraryList.Jj_lib.ObjectIDOf("JJJD10D1"));
            rtn.Add(Honsha01LibraryList.Jj_lib.ObjectIDOf("JJJE00M0"));
            rtn.Add(Honsha01LibraryList.Jj_lib.ObjectIDOf("JJJE05M0"));
            rtn.Add(Honsha01LibraryList.Jj_lib.ObjectIDOf("JJJE10D0"));
