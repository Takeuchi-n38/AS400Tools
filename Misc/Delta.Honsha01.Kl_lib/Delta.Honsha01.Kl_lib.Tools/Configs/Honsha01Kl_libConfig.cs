...
{
    public class Honsha01Kl_libConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Kl_lib;

        public static Honsha01Kl_libConfig Of() => new Honsha01Kl_libConfig();

        Honsha01Kl_libConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = Kl_libLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("CKLH010"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("CKLH020"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("CKLH030"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("CKLH040"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("CKLH050"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("CKLH220"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("CKLH920"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("CKLH920"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("JKLB05D0"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("JKLB20D0"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("JKLBB0D0"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("JKLD01M2"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("JKLD05D2"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("JKLD10D0"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("JKLD15D0"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("JKLE01D0"));
            //rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("JKLE05D0"));
            rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("JKLE01W0"));
            rtn.Add(Honsha01LibraryList.Kl_lib.ObjectIDOf("JKLG05W0"));
