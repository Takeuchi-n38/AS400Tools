...
namespace Delta.Honsha01.Kwxtlib.Tools.Configs
{
    public class Honsha01KwxtlibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Kwxtlib;

        public static Honsha01KwxtlibConfig Of() => new Honsha01KwxtlibConfig();

        Honsha01KwxtlibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = KwxtlibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Kwxtlib.ObjectIDOf("JIJX70D0"));
            rtn.Add(Honsha01LibraryList.Kwxtlib.ObjectIDOf("JIJX20W0"));
            rtn.Add(Honsha01LibraryList.Kwxtlib.ObjectIDOf("JIJX25W0"));
            rtn.Add(Honsha01LibraryList.Kwxtlib.ObjectIDOf("JIJX30W0"));
            rtn.Add(Honsha01LibraryList.Kwxtlib.ObjectIDOf("JIJX35W0"));
            rtn.Add(Honsha01LibraryList.Kwxtlib.ObjectIDOf("JIJX40W0"));
            rtn.Add(Honsha01LibraryList.Kwxtlib.ObjectIDOf("JIJX45W0"));
            rtn.Add(Honsha01LibraryList.Kwxtlib.ObjectIDOf("JIJX48W0"));
            rtn.Add(Honsha01LibraryList.Kwxtlib.ObjectIDOf("JIJX50W0"));
            rtn.Add(Honsha01LibraryList.Kwxtlib.ObjectIDOf("JIJX55W0"));
            rtn.Add(Honsha01LibraryList.Kwxtlib.ObjectIDOf("JIJX56W0"));
            rtn.Add(Honsha01LibraryList.Kwxtlib.ObjectIDOf("JIJX60W0"));
