...
{
    class KwxtlibLibraryFactory : LibraryFactory
    {

        KwxtlibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static KwxtlibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){

                Honsha01LibraryList.Kwxtlib,
            ...
            return new KwxtlibLibraryFactory(ReferLibraries);
        }
