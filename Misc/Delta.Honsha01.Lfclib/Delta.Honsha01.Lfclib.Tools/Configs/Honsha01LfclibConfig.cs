...
namespace Delta.Honsha01.Lfclib.Tools.Configs
{
    public class Honsha01LfclibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Lfclib;

        public static Honsha01LfclibConfig Of() => new Honsha01LfclibConfig();

        Honsha01LfclibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = LfclibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Lfclib.ObjectIDOf("CLFC900"));
            rtn.Add(Honsha01LibraryList.Lfclib.ObjectIDOf("CLFC910"));
