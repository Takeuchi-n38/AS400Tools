...
{
    class LfclibLibraryFactory : LibraryFactory
    {

        LfclibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static LfclibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){
                 Honsha01LibraryList.Lfclib,
        ...
        Honsha01LibraryList.Wrkcat1,
            ...
            return new LfclibLibraryFactory(ReferLibraries);
        }
