...
{
    public class Honsha01LkalibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Lkalib;

        public static Honsha01LkalibConfig Of() => new Honsha01LkalibConfig();

        Honsha01LkalibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = LkalibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            //rtn.Add(Honsha01LibraryList.Lkalib.ObjectIDOf("JLKA05D0"));
            //rtn.Add(Honsha01LibraryList.Lkalib.ObjectIDOf("JLKA25D0"));
            //rtn.Add(Honsha01LibraryList.Lkalib.ObjectIDOf("JLKA26D1"));
            //rtn.Add(Honsha01LibraryList.Lkalib.ObjectIDOf("JLKA95M0"));
            //rtn.Add(Honsha01LibraryList.Lkalib.ObjectIDOf("JLKA99M0"));
            //rtn.Add(Honsha01LibraryList.Lkalib.ObjectIDOf("JLKA99M1"));
            //rtn.Add(Honsha01LibraryList.Lkalib.ObjectIDOf("JLKA80M0"));
            rtn.Add(Honsha01LibraryList.Lkalib.ObjectIDOf("JLKA10W0"));
            rtn.Add(Honsha01LibraryList.Lkalib.ObjectIDOf("JLKA20W0"));
