...
namespace Delta.Honsha01.Mialib.Tools.Configs
{
    public class Honsha01MialibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Mialib;

        public static Honsha01MialibConfig Of() => new Honsha01MialibConfig();

        Honsha01MialibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = MialibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            //rtn.Add(Honsha01LibraryList.Mialib.ObjectIDOf("JMIA00D0"));
            //rtn.Add(Honsha01LibraryList.Mialib.ObjectIDOf("JMIA15D0"));
            //rtn.Add(Honsha01LibraryList.Mialib.ObjectIDOf("JMIA20D0"));
            rtn.Add(Honsha01LibraryList.Mialib.ObjectIDOf("JMIA05M0"));
            rtn.Add(Honsha01LibraryList.Mialib.ObjectIDOf("JMIA30W0"));
