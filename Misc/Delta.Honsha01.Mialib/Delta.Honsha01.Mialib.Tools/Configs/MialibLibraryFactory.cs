...
{
    class MialibLibraryFactory : LibraryFactory
    {

        MialibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static MialibLibraryFactory Of(Library aMainLibrary)
        {
        ...
        Honsha01LibraryList.Wrkcat1,
            ...
            return new MialibLibraryFactory(ReferLibraries);
        }
