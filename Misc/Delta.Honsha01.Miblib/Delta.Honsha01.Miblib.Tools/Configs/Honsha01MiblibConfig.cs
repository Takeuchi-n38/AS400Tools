...
{
    public class Honsha01MiblibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Miblib;

        public static Honsha01MiblibConfig Of() => new Honsha01MiblibConfig();

        Honsha01MiblibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = MiblibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            //rtn.Add(Honsha01LibraryList.Miblib.ObjectIDOf("CMIB000"));
            //rtn.Add(Honsha01LibraryList.Miblib.ObjectIDOf("CMIB010"));
            //rtn.Add(Honsha01LibraryList.Miblib.ObjectIDOf("CMIB910"));
            //rtn.Add(Honsha01LibraryList.Miblib.ObjectIDOf("CMIB920"));
            //rtn.Add(Honsha01LibraryList.Miblib.ObjectIDOf("JMIB00D0"));
            //rtn.Add(Honsha01LibraryList.Miblib.ObjectIDOf("JMIB10D0"));
            //rtn.Add(Honsha01LibraryList.Miblib.ObjectIDOf("JMIB15D0"));
            rtn.Add(Honsha01LibraryList.Miblib.ObjectIDOf("JMIB20D0"));
