...
namespace Delta.Honsha01.Nayflib.Tools.Configs
{
    public class Honsha01NayflibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Nayflib;

        public static Honsha01NayflibConfig Of() => new Honsha01NayflibConfig();

        Honsha01NayflibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = NayfibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Nayflib.ObjectIDOf("JIKA70D0"));
            rtn.Add(Honsha01LibraryList.Nayflib.ObjectIDOf("JIKA20W0"));
            rtn.Add(Honsha01LibraryList.Nayflib.ObjectIDOf("JIKA25W0"));
            rtn.Add(Honsha01LibraryList.Nayflib.ObjectIDOf("JIKA30W0"));
            rtn.Add(Honsha01LibraryList.Nayflib.ObjectIDOf("JIKA35W0"));
            rtn.Add(Honsha01LibraryList.Nayflib.ObjectIDOf("JIKA40W0"));
            rtn.Add(Honsha01LibraryList.Nayflib.ObjectIDOf("JIKA45W0"));
            rtn.Add(Honsha01LibraryList.Nayflib.ObjectIDOf("JIKA50W0"));
            rtn.Add(Honsha01LibraryList.Nayflib.ObjectIDOf("JIKA55W0"));
            rtn.Add(Honsha01LibraryList.Nayflib.ObjectIDOf("JIKA56W0"));
            rtn.Add(Honsha01LibraryList.Nayflib.ObjectIDOf("JIKA60W0"));
