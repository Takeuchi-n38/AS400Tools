...
{
    class NayfibLibraryFactory : LibraryFactory
    {

        NayfibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static NayfibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){

                Honsha01LibraryList.Nayflib,
            ...
            return new NayfibLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            if (libraryName == "&CUR") return Honsha01LibraryList.Nayflib;
