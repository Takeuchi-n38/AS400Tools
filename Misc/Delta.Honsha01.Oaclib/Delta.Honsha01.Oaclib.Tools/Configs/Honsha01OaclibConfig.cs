...
namespace Delta.Honsha01.Oaclib.Tools.Configs
{
    public class Honsha01OaclibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Oaclib;

        public static Honsha01OaclibConfig Of() => new Honsha01OaclibConfig();

        Honsha01OaclibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = OaclibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            //rtn.Add(Honsha01LibraryList.Oaclib.ObjectIDOf("JOAC00D0"));
            //rtn.Add(Honsha01LibraryList.Oaclib.ObjectIDOf("JOAC05D0"));
            //rtn.Add(Honsha01LibraryList.Oaclib.ObjectIDOf("JOAC10D0"));
            rtn.Add(Honsha01LibraryList.Oaclib.ObjectIDOf("JOAC00W0"));
