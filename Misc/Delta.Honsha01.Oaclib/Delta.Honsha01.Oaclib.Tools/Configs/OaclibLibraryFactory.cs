...
{
    class OaclibLibraryFactory : LibraryFactory
    {

        OaclibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static OaclibLibraryFactory Of(Library aMainLibrary)
        {
            ...
            return new OaclibLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            if (libraryName == "&FLL") return Honsha01LibraryList.Oaclib;
