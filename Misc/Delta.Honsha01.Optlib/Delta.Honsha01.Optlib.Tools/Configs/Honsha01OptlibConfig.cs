...
namespace Delta.Honsha01.Optlib.Tools.Configs
{
    public class Honsha01OptlibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Optlib;

        public static Honsha01OptlibConfig Of() => new Honsha01OptlibConfig();

        Honsha01OptlibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = OptlibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            //rtn.Add(Honsha01LibraryList.Optlib.ObjectIDOf("JOPT0001"));
            rtn.Add(Honsha01LibraryList.Optlib.ObjectIDOf("JOPT0000"));
