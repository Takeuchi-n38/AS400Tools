...
{
    class OptlibLibraryFactory : LibraryFactory
    {

        OptlibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static OptlibLibraryFactory Of(Library aMainLibrary)
        {
            ...
            return new OptlibLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            if (libraryName == "&LIB") return Honsha01LibraryList.Optlib;
