...
{
    class PiflibLibraryFactory : LibraryFactory
    {

        PiflibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static PiflibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){

                Honsha01LibraryList.Piflib,
                Honsha01LibraryList.Oplib,

        };
            return new PiflibLibraryFactory(ReferLibraries);
        }
