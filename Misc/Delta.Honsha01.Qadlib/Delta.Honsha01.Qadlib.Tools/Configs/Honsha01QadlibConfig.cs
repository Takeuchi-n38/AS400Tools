...
namespace Delta.Honsha01.Qadlib.Tools.Configs
{
    public class Honsha01QadlibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Qadlib;

        public static Honsha01QadlibConfig Of() => new Honsha01QadlibConfig();

        Honsha01QadlibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = QadlibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Qadlib.ObjectIDOf("JQAD10D0"));
