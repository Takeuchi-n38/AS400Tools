...
{
    class QadlibLibraryFactory : LibraryFactory
    {

        QadlibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static QadlibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){

                Honsha01LibraryList.Qadlib,
                Honsha01LibraryList.Oplib,

        };
            return new QadlibLibraryFactory(ReferLibraries);
        }
