...
namespace Delta.Honsha01.Qkalib.Tools.Configs
{
    public class Honsha01QkalibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Qkalib;

        public static Honsha01QkalibConfig Of() => new Honsha01QkalibConfig();

        Honsha01QkalibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = QkalibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Qkalib.ObjectIDOf("JQKA05D0"));
            rtn.Add(Honsha01LibraryList.Qkalib.ObjectIDOf("JQKA10D0"));
            rtn.Add(Honsha01LibraryList.Qkalib.ObjectIDOf("JQKA15D0"));
