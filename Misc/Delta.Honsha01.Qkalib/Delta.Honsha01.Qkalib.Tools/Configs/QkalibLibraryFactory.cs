...
{
    class QkalibLibraryFactory : LibraryFactory
    {

        QkalibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static QkalibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){
                ...
                Honsha01LibraryList.M2trdlib,

        };
            return new QkalibLibraryFactory(ReferLibraries);
        }
