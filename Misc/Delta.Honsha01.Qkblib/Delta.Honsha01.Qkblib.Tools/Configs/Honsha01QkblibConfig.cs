...
{
    public class Honsha01QkblibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Qkblib;

        public static Honsha01QkblibConfig Of() => new Honsha01QkblibConfig();

        Honsha01QkblibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = QkblibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Qkblib.ObjectIDOf("CQKB005"));
            rtn.Add(Honsha01LibraryList.Qkblib.ObjectIDOf("JQKB05D0"));
