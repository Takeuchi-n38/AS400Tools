...
namespace Delta.Honsha01.Qkdlib.Tools.Configs
{
    public class Honsha01QkdlibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Qkdlib;

        public static Honsha01QkdlibConfig Of() => new Honsha01QkdlibConfig();

        Honsha01QkdlibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = QkdlibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Qkdlib.ObjectIDOf("JQKD10D1"));
            rtn.Add(Honsha01LibraryList.Qkdlib.ObjectIDOf("JQKD05D0"));
