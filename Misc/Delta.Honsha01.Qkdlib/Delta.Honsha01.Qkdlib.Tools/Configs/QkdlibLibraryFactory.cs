...
{
    class QkdlibLibraryFactory : LibraryFactory
    {

        QkdlibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static QkdlibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){

                Honsha01LibraryList.Qkdlib,
            ...
            return new QkdlibLibraryFactory(ReferLibraries);
        }
