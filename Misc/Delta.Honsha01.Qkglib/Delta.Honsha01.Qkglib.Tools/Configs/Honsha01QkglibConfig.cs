...
namespace Delta.Honsha01.Qkglib.Tools.Configs
{
    public class Honsha01QkglibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Qkglib;

        public static Honsha01QkglibConfig Of() => new Honsha01QkglibConfig();

        Honsha01QkglibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = QkglibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Qkglib.ObjectIDOf("JQKG05W0"));
