...
{
    class QkglibLibraryFactory : LibraryFactory
    {

        QkglibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static QkglibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){

                Honsha01LibraryList.Qkglib,
            ...
            return new QkglibLibraryFactory(ReferLibraries);
        }
