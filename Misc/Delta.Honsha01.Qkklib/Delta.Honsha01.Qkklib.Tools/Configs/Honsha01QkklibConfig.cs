...
namespace Delta.Honsha01.Qkklib.Tools.Configs
{
    public class Honsha01QkklibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Qkklib;

        public static Honsha01QkklibConfig Of() => new Honsha01QkklibConfig();

        Honsha01QkklibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = QkklibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Qkklib.ObjectIDOf("JQKK05D0"));
            rtn.Add(Honsha01LibraryList.Qkklib.ObjectIDOf("JQKK10D0"));
            rtn.Add(Honsha01LibraryList.Qkklib.ObjectIDOf("JQKK15D0"));
