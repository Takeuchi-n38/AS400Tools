...
{
    class QkklibLibraryFactory : LibraryFactory
    {

        QkklibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static QkklibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){

                Honsha01LibraryList.Qkklib,
            ...
            return new QkklibLibraryFactory(ReferLibraries);
        }
