...
{
    public class Honsha01Tap_libConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Tap_lib;

        public static Honsha01Tap_libConfig Of() => new Honsha01Tap_libConfig();

        Honsha01Tap_libConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = Tap_libLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Tap_lib.ObjectIDOf("JIJT70D0"));
            rtn.Add(Honsha01LibraryList.Tap_lib.ObjectIDOf("JIJT20W0"));
            rtn.Add(Honsha01LibraryList.Tap_lib.ObjectIDOf("JIJT25W0"));
            rtn.Add(Honsha01LibraryList.Tap_lib.ObjectIDOf("JIJT30W0"));
            rtn.Add(Honsha01LibraryList.Tap_lib.ObjectIDOf("JIJT35W0"));
            rtn.Add(Honsha01LibraryList.Tap_lib.ObjectIDOf("JIJT40W0"));
            rtn.Add(Honsha01LibraryList.Tap_lib.ObjectIDOf("JIJT45W0"));
            rtn.Add(Honsha01LibraryList.Tap_lib.ObjectIDOf("JIJT48W0"));
            rtn.Add(Honsha01LibraryList.Tap_lib.ObjectIDOf("JIJT50W0"));
            rtn.Add(Honsha01LibraryList.Tap_lib.ObjectIDOf("JIJT55W0"));
            rtn.Add(Honsha01LibraryList.Tap_lib.ObjectIDOf("JIJT56W0"));
            rtn.Add(Honsha01LibraryList.Tap_lib.ObjectIDOf("JIJT60W0"));
