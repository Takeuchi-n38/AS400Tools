...
namespace Delta.Honsha01.Tr2lib.Tools.Configs
{
    public class Honsha01Tr2libConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Tr2lib;

        public static Honsha01Tr2libConfig Of() => new Honsha01Tr2libConfig();

        Honsha01Tr2libConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = Tr2libLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Tr2lib.ObjectIDOf("JJIL00D0"));
