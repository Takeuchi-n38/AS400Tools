...
{
    class Tr2libLibraryFactory : LibraryFactory
    {

        Tr2libLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static Tr2libLibraryFactory Of(Library aMainLibrary)
        {
        ...
        Honsha01LibraryList.Wrkcat1,
            ...
            return new Tr2libLibraryFactory(ReferLibraries);
        }
