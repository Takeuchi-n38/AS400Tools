...
namespace Delta.Honsha01.Ukelib.Tools.Configs
{
    public class Honsha01UkelibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Ukelib;

        public static Honsha01UkelibConfig Of() => new Honsha01UkelibConfig();

        Honsha01UkelibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = UkelibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Ukelib.ObjectIDOf("CKLB490"));
