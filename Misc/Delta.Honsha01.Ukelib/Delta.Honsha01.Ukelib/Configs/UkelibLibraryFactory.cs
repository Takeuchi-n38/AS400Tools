...
{
    class UkelibLibraryFactory : LibraryFactory
    {

        UkelibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static UkelibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){
                 Honsha01LibraryList.Ukelib,
                Honsha01LibraryList.Hukelib,
        ...
        Honsha01LibraryList.Wrkcat1,
            ...
            return new UkelibLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            if (libraryName == "*CURLIB") return Honsha01LibraryList.Hukelib;
