...
namespace Delta.Honsha01.Usl2lib.Tools.Configs
{
    public class Honsha01Usl2libConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Usl2lib;

        public static Honsha01Usl2libConfig Of() => new Honsha01Usl2libConfig();

        Honsha01Usl2libConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = Usl2libLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(((IToolConfig)this).MainLibrary.ObjectIDOf("CMENSLD"));
            rtn.Add(((IToolConfig)this).MainLibrary.ObjectIDOf("CMENKEI"));
            rtn.Add(((IToolConfig)this).MainLibrary.ObjectIDOf("CMENMAINT"));
            rtn.Add(((IToolConfig)this).MainLibrary.ObjectIDOf("CMENSHK"));
            rtn.Add(Honsha01LibraryList.Usl3lib.ObjectIDOf("CJIE883"));
