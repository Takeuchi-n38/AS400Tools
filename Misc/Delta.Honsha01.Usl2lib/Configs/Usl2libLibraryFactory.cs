...
{
    class Usl2libLibraryFactory : LibraryFactory
    {

        Usl2libLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static Usl2libLibraryFactory Of(Library aMainLibrary)
        {
        ...
        **/
            ...
            return new Usl2libLibraryFactory(ReferLibraries);
        }
