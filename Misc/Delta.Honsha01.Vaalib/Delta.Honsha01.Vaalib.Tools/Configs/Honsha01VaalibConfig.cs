...
namespace Delta.Honsha01.Vaalib.Tools.Configs
{
    public class Honsha01VaalibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Vaalib;

        public static Honsha01VaalibConfig Of() => new Honsha01VaalibConfig();

        Honsha01VaalibConfig()
        {
        }
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Vaalib.ObjectIDOf("JVAA50MK"));
            rtn.Add(Honsha01LibraryList.Vaalib.ObjectIDOf("JVAA63MK"));
            rtn.Add(Honsha01LibraryList.Vaalib.ObjectIDOf("JVAA80MU"));
            rtn.Add(Honsha01LibraryList.Vaalib.ObjectIDOf("JVAA81MU"));
