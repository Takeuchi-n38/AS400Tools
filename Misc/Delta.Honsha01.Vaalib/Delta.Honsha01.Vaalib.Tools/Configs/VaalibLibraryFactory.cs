...
{
    class VaalibLibraryFactory : LibraryFactory
    {

        VaalibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static VaalibLibraryFactory Of(Library aMainLibrary)
        {
            ...
            return new VaalibLibraryFactory(ReferLibraries);
        }
