...
namespace Delta.Honsha01.Yb_lib.Tools.Configs
{
    public class Honsha01Yb_libConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Yb_lib;

        public static Honsha01Yb_libConfig Of() => new Honsha01Yb_libConfig();

        Honsha01Yb_libConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = Yb_libLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB02D0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB05D0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB07D0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB08D0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB09D0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB10D0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB11D0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB13D0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB15D0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB17D0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB19D0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB20D0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB23D0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB25M0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB60D0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBB70M0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBBA9D0"));
            rtn.Add(Honsha01LibraryList.Yb_lib.ObjectIDOf("JYBBXXD0"));
