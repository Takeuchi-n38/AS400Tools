...
{
    class Yb_libLibraryFactory : LibraryFactory
    {

        Yb_libLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static Yb_libLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){

                Honsha01LibraryList.Yb_lib,
                Honsha01LibraryList.Oplib,
                Honsha01LibraryList.Prodlib,
                Honsha01LibraryList.Hi_lib,
                Honsha01LibraryList.Iidlib,
            ...
            return new Yb_libLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            if (libraryName == "&IJA") return Honsha01LibraryList.Ijalib;
            if (libraryName == "&IIA") return Honsha01LibraryList.Iialib;
            //if (libraryName == "&CUR") return Honsha01LibraryList.Iidlib;
            if (libraryName == "&VAA") return Honsha01LibraryList.Vaalib;
            if (libraryName == "&LIB") return Honsha01LibraryList.Yb_lib;
