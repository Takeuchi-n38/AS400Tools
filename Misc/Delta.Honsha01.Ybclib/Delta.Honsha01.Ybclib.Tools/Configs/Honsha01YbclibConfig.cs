...
namespace Delta.Honsha01.Ybclib.Tools.Configs
{
    public class Honsha01YbclibConfig : IAnalyzerConfig, IGeneratorConfig
    {

        public static Library MainLibrary = Honsha01LibraryList.Ybclib;

        public static Honsha01YbclibConfig Of() => new Honsha01YbclibConfig();

        Honsha01YbclibConfig()
        {
        }
        ...
        LibraryFactory IToolConfig.LibraryFactory { get; } = YbclibLibraryFactory.Of(MainLibrary);
        ...
        List<ObjectID> IAnalyzerConfig.EntryObjectIDs()
        {
            ...
            rtn.Add(Honsha01LibraryList.Ybclib.ObjectIDOf("JYBC00D0"));
            rtn.Add(Honsha01LibraryList.Ybclib.ObjectIDOf("JYBC05M0"));
            rtn.Add(Honsha01LibraryList.Ybclib.ObjectIDOf("JYBC10D0"));
            rtn.Add(Honsha01LibraryList.Ybclib.ObjectIDOf("JYBC11D0"));
            rtn.Add(Honsha01LibraryList.Ybclib.ObjectIDOf("JYBC40D0"));
            rtn.Add(Honsha01LibraryList.Ybclib.ObjectIDOf("JYBC60D0"));
            rtn.Add(Honsha01LibraryList.Ybclib.ObjectIDOf("JYBC80D0"));
            rtn.Add(Honsha01LibraryList.Ybclib.ObjectIDOf("JYBCA0D0"));
