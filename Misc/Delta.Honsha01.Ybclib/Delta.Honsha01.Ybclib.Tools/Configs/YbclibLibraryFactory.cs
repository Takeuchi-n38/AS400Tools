...
{
    class YbclibLibraryFactory : LibraryFactory
    {

        YbclibLibraryFactory(List<Library> Libraries) : base(Libraries)
        {
                   
        }

        public static YbclibLibraryFactory Of(Library aMainLibrary)
        {
            var ReferLibraries = new List<Library>(){
                ...
                Honsha01LibraryList.Vaalib,
                Honsha01LibraryList.Kl_lib,
                Honsha01LibraryList.Ki_lib,
                Honsha01LibraryList.Madlib,
                Honsha01LibraryList.Ijalib,

        };
            return new YbclibLibraryFactory(ReferLibraries);
        }
        ...
        public override Library Create(string libraryName)
        {
            ...
            if (libraryName == "&LFF") return Honsha01LibraryList.Lfflib;
            if (libraryName == "&LFD") return Honsha01LibraryList.Lfdlib;
            if (libraryName == "&IJA") return Honsha01LibraryList.Ijalib;
            if (libraryName == "&IIA") return Honsha01LibraryList.Iialib;
            if (libraryName == "&CUR") return Honsha01LibraryList.Weblib;
            if (libraryName == "&VAA") return Honsha01LibraryList.Vaalib;
            if (libraryName == "*CURLIB") return Honsha01LibraryList.Tachilib;
            if (libraryName == "&MAD") return Honsha01LibraryList.Madlib;
