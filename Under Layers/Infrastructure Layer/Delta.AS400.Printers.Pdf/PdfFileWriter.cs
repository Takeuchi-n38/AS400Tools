//using Delta.AS400.DataDescriptionSpecifications.Printers;
using System;
...
namespace Delta.Pdfs
{
    public class PdfFileWriter
    {
        ...
        public static void Output(string pdfPath, List<Dictionary<int, PdfLine>> pdfLineCollectionList, float fontHeight)
        {
            Output(pdfPath, Contents(pdfLineCollectionList, fontHeight));
        }

        private static string Contents(List<Dictionary<int, PdfLine>> pdfPages, float fontHeight)
        {
        ...
        private static List<PdfObject> GetPdfObjects(List<Dictionary<int, PdfLine>> pdfPages, PdfFont pdfFont)
        {
        ...
        private static PdfObject GetContentPageObject(Dictionary<int, PdfLine> pdfLines, int contentObjId, PdfFont pdfFont)
        {
