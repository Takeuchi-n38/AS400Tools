...
{
    public class FocusControlBehavior
    {
        ...
        static FocusControlBehavior()
        {
            OnProperty = DependencyProperty.RegisterAttached("On", typeof(FrameworkElement), typeof(FocusControlBehavior), new PropertyMetadata(OnSetCallback));
        }
