...
{
    public class PostgresOperatedBySQLWithNpgsql : DatabaseOperatedBySQL
    {
        PostgresOperatedBySQLWithNpgsql(string aConnectionString) : base(PostgresObjectsFactory.Of(aConnectionString))
        {
        }

        public static PostgresOperatedBySQLWithNpgsql Of(DbConnectionStringBuilder aDbConnectionStringBuilder)
        {
            return new PostgresOperatedBySQLWithNpgsql(aDbConnectionStringBuilder.ConnectionString);
        }
