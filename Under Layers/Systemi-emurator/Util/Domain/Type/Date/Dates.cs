...
{
    public class Dates : FirstClassList<Date>
    {
        public Dates() : base(new List<Date>())
        {
        }
        public static Dates Of()
        {
            return new Dates();
        }
        public static Dates Of(Date firstItem)
        {
            var instance = Of();
        ...
        {
            return this.IndexOf(Date.Of(yyyyMMdd));
        }
